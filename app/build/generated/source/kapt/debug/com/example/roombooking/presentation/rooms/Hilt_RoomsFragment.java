...
public abstract class Hilt_RoomsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RoomsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RoomsFragment_GeneratedInjector) this.generatedComponent()).injectRoomsFragment(UnsafeCasts.<RoomsFragment>unsafeCast(this));
    }
  }
