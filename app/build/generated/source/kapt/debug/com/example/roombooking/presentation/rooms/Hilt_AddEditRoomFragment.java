...
public abstract class Hilt_AddEditRoomFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditRoomFragment() {
    super();
  }

  Hilt_AddEditRoomFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditRoomFragment_GeneratedInjector) this.generatedComponent()).injectAddEditRoomFragment(UnsafeCasts.<AddEditRoomFragment>unsafeCast(this));
    }
  }
