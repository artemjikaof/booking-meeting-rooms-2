...
public abstract class Hilt_AddEditEventFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditEventFragment() {
    super();
  }

  Hilt_AddEditEventFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditEventFragment_GeneratedInjector) this.generatedComponent()).injectAddEditEventFragment(UnsafeCasts.<AddEditEventFragment>unsafeCast(this));
    }
  }
