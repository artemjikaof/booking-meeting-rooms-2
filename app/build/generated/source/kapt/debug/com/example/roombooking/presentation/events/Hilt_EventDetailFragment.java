...
public abstract class Hilt_EventDetailFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EventDetailFragment() {
    super();
  }

  Hilt_EventDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EventDetailFragment_GeneratedInjector) this.generatedComponent()).injectEventDetailFragment(UnsafeCasts.<EventDetailFragment>unsafeCast(this));
    }
  }
