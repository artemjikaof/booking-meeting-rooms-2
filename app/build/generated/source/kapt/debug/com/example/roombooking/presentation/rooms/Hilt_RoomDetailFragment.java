...
public abstract class Hilt_RoomDetailFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RoomDetailFragment() {
    super();
  }

  Hilt_RoomDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RoomDetailFragment_GeneratedInjector) this.generatedComponent()).injectRoomDetailFragment(UnsafeCasts.<RoomDetailFragment>unsafeCast(this));
    }
  }
