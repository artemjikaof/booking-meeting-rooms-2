...
public final class FragmentFilterBinding implements ViewBinding {
  ...
  private FragmentFilterBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnApply,
      @NonNull MaterialButton btnReset, @NonNull MaterialToolbar toolbar) {
  ...
  public static FragmentFilterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFilterBinding((LinearLayout) rootView, btnApply, btnReset, toolbar);
    }
